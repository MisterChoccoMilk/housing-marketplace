...
namespace marketplace.Migrations
{
    ...
    [Migration("20221117232613_identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("marketplace.Auth.Model.MarketplaceRestUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("marketplace.Auth.Model.MarketplaceRestUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("marketplace.Data.Entities.Category", b =>
                {
                    b.HasOne("marketplace.Auth.Model.MarketplaceRestUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
